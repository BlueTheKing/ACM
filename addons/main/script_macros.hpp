...
#define GET_EFF_BLOOD_VOLUME(unit) (6 min ((unit getVariable [QEGVAR(circulation,Blood_Volume), 6]) + ((unit getVariable [QEGVAR(circulation,Plasma_Volume), 0]) * 0.3)) max 0)
