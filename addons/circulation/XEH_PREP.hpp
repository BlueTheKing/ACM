PREP(administerMedication);
PREP(administerMedicationItem);
PREP(administerMedicationLocal);
...
PREP(effectAdenosine);
PREP(effectAmiodarone);
PREP(effectAmmonia);
PREP(effectAtropine);
PREP(effectCalciumChloride);
PREP(effectDimercaprol);
PREP(effectFentanyl);
PREP(effectKetamine);
PREP(effectLidocaine);
PREP(effectMorphine);
PREP(effectTXA);
PREP(effectVitalsAmmonia);
PREP(effectVitalsAdenosine);
PREP(effectVitalsAmiodarone);
PREP(effectVitalsAtropine);
PREP(effectVitalsCalciumChloride);
PREP(effectVitalsEpinephrine);
PREP(effectVitalsEsmolol);
PREP(effectVitalsFentanyl);
PREP(effectVitalsKetamine);
PREP(effectVitalsLidocaine);
PREP(effectVitalsMethoxyflurane);
PREP(effectVitalsMidazolam);
PREP(effectVitalsMorphine);
PREP(effectParacetamol);
PREP(effectVitalsOndansetron);
PREP(effectVitalsParacetamol);
PREP(effectVitalsTXA);
PREP(feelPulse);
PREP(formatFluidBagName);
PREP(generateBloodType);
PREP(generateBloodTypeList);
PREP(generateFreshBloodEntry);
PREP(getAccessType);
PREP(getApplyPadsTime);
PREP(getBleedingMultiplier);
PREP(getCapillaryDamageBleedingRate);
PREP(getCardiacMedicationEffects);
PREP(getCoagulationMedicationEffect);
PREP(getEKGHeartRate);
PREP(getFluidBagConfigName);
PREP(getFluidBagString);
PREP(getFreshBloodEntry);
PREP(getHemothoraxBleedingRate);
PREP(getInternalBleedingRate);
PREP(getIVFlowRate);
PREP(getMAP);
PREP(getMedicationConcentration_Single);
PREP(getMedicationConcentration);
...
PREP(TransfusionMenu_onKeyDown);
