...
class GVAR(Lifepak_Monitor_Dialog) {
    ...
    class ControlsBackground {
        class Black_Background: RscText {
            idc = -1;
            x = QUOTE(ACM_pxToScreen_X((AED_TOPLEFT_X - 20)));
            y = QUOTE(ACM_pxToScreen_Y((AED_TOPLEFT_Y - 20)));
            w = QUOTE(ACM_pxToScreen_W(1000));
            h = QUOTE(ACM_pxToScreen_H(700));
            colorBackground[] = {0,0,0,1};
        };
        class Black_Background2: Black_Background {};
        class VitalsSection_Background: RscText {
            idc = -1;
            x = QUOTE(ACM_pxToScreen_X((AED_TOPLEFT_X - 10))); // 330
            y = QUOTE(ACM_pxToScreen_Y(AED_TOPLEFT_Y)); // 900
            w = QUOTE(ACM_pxToScreen_W(180));
            h = QUOTE(ACM_pxToScreen_H(550));
        ...
        class HR_Vitals_Background: RscText {
            idc = -1;
            x = QUOTE(ACM_pxToScreen_X((AED_TOPLEFT_X - 10))); // 330
            y = QUOTE(ACM_pxToScreen_Y(VitalsBG_Spacing_Y(0)));
            w = QUOTE(ACM_pxToScreen_W(180));
            h = QUOTE(ACM_pxToScreen_H(140));
            colorBackground[] = {0,0,0,1};
        };
        class SpO2_Vitals_Background: HR_Vitals_Background {
            idc = -1;
            y = QUOTE(ACM_pxToScreen_Y(VitalsBG_Spacing_Y(1)));
        };
        class CO2_Vitals_Background: HR_Vitals_Background {
            idc = -1;
            y = QUOTE(ACM_pxToScreen_Y(VitalsBG_Spacing_Y(2)));
        };
        class BP_Vitals_Background: HR_Vitals_Background {
            idc = -1;
            y = QUOTE(ACM_pxToScreen_Y(VitalsBG_Spacing_Y(3)));
        };
        class Top_Bar_Background: VitalsSection_Background {
            idc = -1;
            y = QUOTE(ACM_pxToScreen_Y(AED_TOPLEFT_Y)); // 880
            w = QUOTE(ACM_pxToScreen_W(900));
            h = QUOTE(ACM_pxToScreen_H(20));
        };
        class Vitals_SectionDivider_Background: VitalsSection_Background {
            idc = -1;
            x = QUOTE(ACM_pxToScreen_X((AED_TOPLEFT_X + 169)));
            w = QUOTE(ACM_pxToScreen_W(2));
            h = QUOTE(ACM_pxToScreen_H(660));
        };
        ...
        class SpO2_Vitals_Header: HR_Vitals_Header {
            idc = -1;
            y = QUOTE(ACM_pxToScreen_Y(VitalsHeader_Spacing_Y(1)));
            colorText[] = SPO2_COLOR;
            text = "SpO2";
        };
        class CO2_Vitals_Header: HR_Vitals_Header {
            idc = -1;
            y = QUOTE(ACM_pxToScreen_Y(VitalsHeader_Spacing_Y(2)));
            colorText[] = CO2_COLOR;
            text = "CO2";
        };
        class BP_Vitals_Header: HR_Vitals_Header {
            idc = -1;
            y = QUOTE(ACM_pxToScreen_Y(VitalsHeader_Spacing_Y(3)));
        ...
        class HR_Vitals_Display: RscText {
            ...
            x = QUOTE(ACM_pxToScreen_X((AED_TOPLEFT_X + 50))); // 380
            y = QUOTE(ACM_pxToScreen_Y(VitalsDisplay_Spacing_Y(0)));
            w = QUOTE(ACM_pxToScreen_W(125));
            h = QUOTE(ACM_pxToScreen_H(90));
            colorBackground[] = {0,0,0,0};
            colorText[] = HR_COLOR;
        ...
        class SpO2_Vitals_Display: HR_Vitals_Display {
            ...
            x = QUOTE(ACM_pxToScreen_X((AED_TOPLEFT_X + 60))); // 390
            y = QUOTE(ACM_pxToScreen_Y(VitalsDisplay_Spacing_Y(1)));
            w = QUOTE(ACM_pxToScreen_W(115));
            h = QUOTE(ACM_pxToScreen_H(93));
            colorText[] = SPO2_COLOR;
            font = "RobotoCondensedBold";
        ...
        class CO2_Vitals_Display: SpO2_Vitals_Display {
            ...
            y = QUOTE(ACM_pxToScreen_Y(VitalsDisplay_Spacing_Y(2)));
            w = QUOTE(ACM_pxToScreen_W(115));
            h = QUOTE(ACM_pxToScreen_H(93));
            colorText[] = CO2_COLOR;
            text = "0";
        ...
        class RR_Vitals_Display: CO2_Vitals_Display {
            ...
            x = QUOTE(ACM_pxToScreen_X((AED_TOPLEFT_X - 38)));
            y = QUOTE(ACM_pxToScreen_Y((VitalsDisplay_Spacing_Y(2) + 12)));
            w = QUOTE(ACM_pxToScreen_W(80));
            h = QUOTE(ACM_pxToScreen_H(80));
        ...
        class RR_Text_Vitals_Display: RR_Vitals_Display {
            ...
            x = QUOTE(ACM_pxToScreen_X((AED_TOPLEFT_X - 14)));
            y = QUOTE(ACM_pxToScreen_Y((VitalsDisplay_Spacing_Y(2) + 9)));
        ...
        class NIBP_S_Vitals_Display: SpO2_Vitals_Display {
            ...
            y = QUOTE(ACM_pxToScreen_Y(VitalsDisplay_Spacing_Y(3)));
            w = QUOTE(ACM_pxToScreen_W(115));
            h = QUOTE(ACM_pxToScreen_H(93));
            colorText[] = NIBP_COLOR;
            text = "0";
        ...
        class NIBP_D_Vitals_Display: SpO2_Vitals_Display {
            ...
            y = QUOTE(ACM_pxToScreen_Y((VitalsDisplay_Spacing_Y(3) + 55)));
            colorText[] = NIBP_COLOR;
            text = "0";
        };
        class NIBP_Mean_Vitals_Display: NIBP_D_Vitals_Display {
            idc = IDC_VITALSDISPLAY_NIBP_M;
            x = QUOTE(ACM_pxToScreen_X((AED_TOPLEFT_X - 48)));
            y = QUOTE(ACM_pxToScreen_Y((VitalsDisplay_Spacing_Y(3) + 68)));
            w = QUOTE(ACM_pxToScreen_W(100));
            h = QUOTE(ACM_pxToScreen_H(90));
            sizeEx = QUOTE(ACM_GRID_H * 0.8 * (0.55 / (getResolution select 5)));
            text = "0";
        };
        ...
        class EKG_Line_0: RscLine {
            idc = IDC_EKG_LINE_0;
            x = QUOTE(ACM_pxToScreen_X(EKG_Line_X(0)));
            y = QUOTE(ACM_pxToScreen_Y(EKG_Line_Y(0)));
            w = QUOTE(ACM_pxToScreen_W(EKG_ColumnWidth));
            h = QUOTE(ACM_pxToScreen_H(0));
            colorBackground[] = {0,0,0,0};
            colorText[] = HR_COLOR;
            text = "";
        };
        ...
        class PO_Line_0: RscLine {
            idc = IDC_PO_LINE_0;
            x = QUOTE(ACM_pxToScreen_X(EKG_Line_X(0)));
            y = QUOTE(ACM_pxToScreen_Y(EKG_Line_Y(160)));
            w = QUOTE(ACM_pxToScreen_W(EKG_ColumnWidth));
            h = QUOTE(ACM_pxToScreen_H(0));
            colorBackground[] = {0,0,0,0};
            colorText[] = SPO2_COLOR;
        ...
        class AEDBackground: RscPicture {
            idc = -1;
            x = QUOTE(ACM_GUI_GRID_X);
            y = QUOTE(ACM_GUI_GRID_Y);
            w = QUOTE(ACM_GUI_GRID_W * ACM_GUI_SIZEM);
            h = QUOTE(ACM_GUI_GRID_H * ACM_GUI_SIZEM);
            type = 0;
            style = 48;
            size = 0;
        ...
        /*class Test_Background: RscText {
            idc = -1;
            x = QUOTE(ACM_pxToScreen_X(AED_BUTTON_TOPLEFT_X));
            y = QUOTE(ACM_pxToScreen_Y(AED_BUTTON_TOPLEFT_Y));
            w = QUOTE(ACM_pxToScreen_W(AED_BUTTON_W));
            h = QUOTE(ACM_pxToScreen_H(AED_BUTTON_H));
    ...
    class Controls {
        class Button_Power: RscButton {
            ...
            idc = -1;
            style = 0;
            x = QUOTE(ACM_pxToScreen_X((AED_BUTTON_TOPLEFT_X + 189)));
            y = QUOTE(ACM_pxToScreen_Y(AED_BUTTON_TOPLEFT_Y));
            w = QUOTE(ACM_pxToScreen_W(AED_BUTTON_W));
            h = QUOTE(ACM_pxToScreen_H(AED_BUTTON_H));
            shadow = 0;
        ...
        class Button_CPR: Button_Power {
            idc = -1;
            x = QUOTE(ACM_pxToScreen_X(AED_BUTTON_TOPLEFT_X));
            y = QUOTE(ACM_pxToScreen_Y((AED_BUTTON_TOPLEFT_Y + AED_BUTTON_Spacing_V)));
        ...
        class Button_Analyze: Button_CPR {
            idc = -1;
            x = QUOTE(ACM_pxToScreen_X(AED_BUTTON_TOPLEFT_X));
            y = QUOTE(ACM_pxToScreen_Y((AED_BUTTON_TOPLEFT_Y + (AED_BUTTON_Spacing_V * 2) - 15)));
        ...
        class Button_NIBP: Button_CPR {
            ...
            y = QUOTE(ACM_pxToScreen_Y((AED_BUTTON_TOPLEFT_Y + (AED_BUTTON_Spacing_V * 4) + 27)));
        ...
        class Button_Charge: Button_Power {
            idc = -1;
            x = QUOTE(ACM_pxToScreen_X((AED_BUTTON_TOPLEFT_X + 189)));
            y = QUOTE(ACM_pxToScreen_Y((AED_BUTTON_TOPLEFT_Y + (AED_BUTTON_Spacing_V * 2) - 16)));
        ...
        class Button_Shock: Button_Power {
            idc = -1;
            x = QUOTE(ACM_pxToScreen_X((AED_BUTTON_TOPLEFT_X + 223)));
            y = QUOTE(ACM_pxToScreen_Y((AED_BUTTON_TOPLEFT_Y + (AED_BUTTON_Spacing_V * 3) - 25)));
            w = QUOTE(ACM_pxToScreen_W(80));
            h = QUOTE(ACM_pxToScreen_H(80));
        ...
        class Button_SpeedDial: Button_Power {
            ...
            idc = -1;
            x = QUOTE(ACM_pxToScreen_X((AED_BUTTON_TOPLEFT_X + 140)));
            y = QUOTE(ACM_pxToScreen_Y((AED_BUTTON_TOPLEFT_Y + 670)));
            w = QUOTE(ACM_pxToScreen_W(180));
            h = QUOTE(ACM_pxToScreen_H(180));
