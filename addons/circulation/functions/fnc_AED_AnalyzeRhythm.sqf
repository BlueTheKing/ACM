...
}, [_medic, _patient], _timeToAnalyze, 
{
    ...
    private _shockable = (((_patient getVariable [QGVAR(Cardiac_RhythmState), ACM_Rhythm_Sinus]) in [ACM_Rhythm_VF,ACM_Rhythm_PVT,ACM_Rhythm_VT]) && !([_patient] call FUNC(recentAEDShock)));
