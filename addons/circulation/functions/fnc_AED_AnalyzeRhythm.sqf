...
}, [_medic, _patient], _timeToAnalyze, 
{
    ...
    private _shockable = (((_patient getVariable [QGVAR(CardiacArrest_RhythmState), ACM_Rhythm_Sinus]) in [ACM_Rhythm_VF,ACM_Rhythm_PVT]) && !([_patient] call FUNC(recentAEDShock)));
