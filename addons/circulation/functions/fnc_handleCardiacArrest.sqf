...
private _PFH = [{
    ...
    private _lastDeteriorateTime = (_patient getVariable [QGVAR(CardiacArrest_DeteriorationTime), -1]) - CBA_missionTime;
...
}, (15 + (random 15)), [_patient, _deteriorateInterval]] call CBA_fnc_addPerFrameHandler;
