class CfgWeapons {
    ...
    class ACM_Vial_Midazolam: ACM_Vial_Epinephrine {
        picture = QPATHTOF(ui\vial_midazolam_ca.paa);
    ...
    class ACM_Vial_Naloxone: ACM_Vial_Epinephrine {
        picture = QPATHTOF(ui\vial_naloxone_ca.paa);
        displayName = CSTRING(Vial_Naloxone);
        descriptionShort = CSTRING(Vial_Naloxone_Desc);
    };
