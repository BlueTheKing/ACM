...
_unit setVariable [VAR_PAIN, 0 max (_pain - _deltaT / 1800), _syncValue];

if (isNil QACEGVAR(medical_treatment,advancedMedication) || {!ACEGVAR(medical_treatment,advancedMedication)}) then {
