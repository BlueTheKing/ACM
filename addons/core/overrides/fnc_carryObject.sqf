...
// Add anim changed EH
[_unit, "AnimChanged", ACELINKFUNC(dragging,handleAnimChanged), [_unit]] call CBA_fnc_addBISEventHandler;
...
// Check everything
[ACELINKFUNC(dragging,carryObjectPFH), 0.5, [_unit, _target, CBA_missionTime]] call CBA_fnc_addPerFrameHandler;