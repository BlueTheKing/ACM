 ...
 * 7: Respiration Rate Adjust <NUMBER>
 *
 * Return Value:
 * None
 *
 ...
 * Public: No
 */
params ["_unit", "_medication", "_timeToMaxEffect", "_maxTimeInSystem", "_hrAdjust", "_painAdjust", "_flowAdjust", "_rrAdjust"];
...
_adjustments pushBack [_medication, CBA_missionTime, _timeToMaxEffect, _maxTimeInSystem, _hrAdjust, _painAdjust, _flowAdjust, _rrAdjust];
