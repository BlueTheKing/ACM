...
_unit setVariable [QACEGVAR(medical_feedback,forceSay3D) + _type, CBA_missionTime + _timeOut];
...
[QACEGVAR(medical_feedback,forceSay3D), [_unit, _sound, _distance], _targets] call CBA_fnc_targetEvent;
