...
if !(alive _target && {_target getVariable [QACEGVAR(dragging,canCarry), false]} && {isNull objectParent _target}) exitWith {false};
...
if (_target isKindOf "CAManBase") exitWith {
    ...
    {_target getVariable [QGVAR(Lying_State), false] || {lifeState _target == "INCAPACITATED" ||
