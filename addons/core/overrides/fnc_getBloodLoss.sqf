...
(_woundBleeding * (_cardiacOutput max CARDIAC_OUTPUT_MIN_DEFAULT) * _bloodPressureModifier * _coagulationModifier * ACEGVAR(medical,bleedingCoefficient)) // CARIDAC_OUTPUT_MIN (lol)
