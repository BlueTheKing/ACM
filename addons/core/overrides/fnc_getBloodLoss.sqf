...
(_woundBleeding * ((_cardiacOutput * _bloodPressureModifier) max CARDIAC_OUTPUT_MIN_DEFAULT) * _coagulationModifier * ACEGVAR(medical,bleedingCoefficient)) // CARIDAC_OUTPUT_MIN (lol)
